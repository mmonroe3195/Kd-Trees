...
def create_kdtree(points: List[Tuple[int,int]], sorted_y = None, depth = 0):
    ...
    #make vertical line
        ...
        for point in sorted_y:
            ...
            if points[median_index] == point:
                left_sorted_y.append(point)
            elif orient(points[median_index], (x_coordinate, y_coordinate + 1), \
               point) != -1:
                left_sorted_y.append(point)
            else:
    ...
    #make horizonal line
        ...
        for point in points:
            ...
            if sorted_y[median_index] == point:
                bottom_sorted_x.append(point)
            elif orient(sorted_y[median_index], (x_coordinate + 1, y_coordinate), \
               point) != 1:
                bottom_sorted_x.append(point)
            else:
